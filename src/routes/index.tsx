      ...
      <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_1fr] lg:gap-10">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a href="https://wa.me/918330961514?text=Hello%20can%20I%20get%20more%20info" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 rounded-2xl border border-border bg-white/70 px-6 py-3.5 text-sm font-semibold text-foreground shadow-soft backdrop-blur transition-all hover:-translate-y-0.5 hover:bg-white">
...
function OpenAIIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M22.28 9.98a5.57 5.57 0 0 0-.48-4.57 5.65 5.65 0 0 0-6.08-2.72A5.64 5.64 0 0 0 11.5 1a5.65 5.65 0 0 0-5.38 3.91 5.65 5.65 0 0 0-3.77 2.74 5.65 5.65 0 0 0 .7 6.63 5.57 5.57 0 0 0 .48 4.57 5.65 5.65 0 0 0 6.08 2.72A5.63 5.63 0 0 0 12.5 23a5.65 5.65 0 0 0 5.38-3.91 5.65 5.65 0 0 0 3.77-2.74 5.65 5.65 0 0 0-.37-6.37ZM12.5 21.5a4.18 4.18 0 0 1-2.69-.97l.13-.08 4.47-2.58a.74.74 0 0 0 .37-.64v-6.3l1.89 1.09a.07.07 0 0 1 .04.05v5.22a4.2 4.2 0 0 1-4.21 4.21Zm-9.03-3.87a4.19 4.19 0 0 1-.5-2.82l.13.08 4.47 2.58a.74.74 0 0 0 .74 0l5.46-3.15v2.18a.07.07 0 0 1-.03.06L9.2 18.65a4.2 4.2 0 0 1-5.73-1.02Zm-1.17-9.75a4.18 4.18 0 0 1 2.19-1.84v5.33a.74.74 0 0 0 .37.64l5.46 3.15-1.89 1.09a.07.07 0 0 1-.07 0L3.83 13.1a4.2 4.2 0 0 1-.53-5.22Zm15.52 3.6-5.46-3.15 1.89-1.09a.07.07 0 0 1 .07 0l4.53 2.62a4.2 4.2 0 0 1-.65 7.57V11.8a.74.74 0 0 0-.38-.32Zm1.88-2.83-.13-.08-4.47-2.58a.74.74 0 0 0-.74 0L8.9 9.64V7.46a.07.07 0 0 1 .03-.06l4.53-2.62a4.2 4.2 0 0 1 6.24 4.35Zm-11.84 3.9-1.89-1.09a.07.07 0 0 1-.04-.05V6.19a4.2 4.2 0 0 1 6.89-3.22l-.13.08-4.47 2.58a.74.74 0 0 0-.37.64v6.3Zm1.02-2.21 2.43-1.4 2.43 1.4v2.8l-2.43 1.4-2.43-1.4v-2.8Z" />
    </svg>
  );
}
...
function AWSIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M6.76 10.45c0 .28.03.5.08.67.06.17.14.35.25.55a.34.34 0 0 1 .06.18c0 .08-.05.16-.15.24l-.5.33a.38.38 0 0 1-.2.07c-.08 0-.16-.04-.24-.11a2.46 2.46 0 0 1-.29-.38 6.3 6.3 0 0 1-.25-.48c-.62.73-1.4 1.1-2.34 1.1-.67 0-1.2-.19-1.59-.57-.39-.38-.59-.89-.59-1.52 0-.67.24-1.22.71-1.63.48-.41 1.11-.62 1.92-.62.27 0 .54.02.83.06.29.04.58.1.89.17v-.57c0-.59-.12-1-.37-1.25-.25-.25-.68-.37-1.29-.37-.28 0-.56.03-.85.1a6.3 6.3 0 0 0-.85.27 2.27 2.27 0 0 1-.28.1.49.49 0 0 1-.13.02c-.11 0-.17-.08-.17-.25v-.4c0-.13.02-.22.06-.28a.63.63 0 0 1 .24-.17c.28-.14.61-.26 1-.36a4.8 4.8 0 0 1 1.24-.15c.94 0 1.63.21 2.07.64.43.43.65 1.08.65 1.96v2.58Zm-3.23.84c.26 0 .52-.05.8-.14.28-.09.52-.26.73-.48.12-.14.21-.3.26-.48.05-.18.08-.4.08-.65v-.31a6.7 6.7 0 0 0-.72-.13 5.88 5.88 0 0 0-.73-.05c-.52 0-.9.1-1.15.31-.25.2-.38.49-.38.87 0 .36.09.63.28.81.18.19.44.25.83.25Zm6.2.82c-.14 0-.24-.02-.3-.08-.06-.05-.11-.16-.16-.31l-1.77-5.83c-.05-.16-.07-.26-.07-.32 0-.13.06-.2.19-.2h.78c.15 0 .25.02.31.08.06.05.1.16.15.31l1.27 4.99 1.17-4.99c.04-.16.09-.26.15-.31.06-.06.17-.08.32-.08h.63c.15 0 .25.02.32.08.06.05.12.16.15.31l1.19 5.05 1.3-5.05c.05-.16.1-.26.15-.31.06-.06.17-.08.31-.08h.74c.13 0 .2.06.2.2 0 .04-.01.08-.02.13a1.23 1.23 0 0 1-.06.2l-1.81 5.83c-.05.16-.1.26-.16.31-.06.05-.16.08-.3.08h-.68c-.15 0-.25-.02-.32-.08-.06-.06-.12-.16-.15-.32L11.7 7.2l-1.16 4.82c-.04.16-.09.26-.15.32-.06.06-.17.08-.32.08h-.64Zm9.63.17a5.1 5.1 0 0 1-1.18-.14 3.5 3.5 0 0 1-.88-.33c-.12-.07-.21-.15-.24-.22a.56.56 0 0 1-.04-.22v-.41c0-.17.06-.25.18-.25.05 0 .1.01.15.03l.21.1c.28.13.58.23.9.3.33.07.65.1.98.1.52 0 .92-.09 1.2-.27.28-.18.43-.44.43-.78 0-.23-.07-.42-.22-.58-.15-.16-.43-.3-.84-.44l-1.2-.37c-.61-.19-1.06-.47-1.34-.84a2.01 2.01 0 0 1-.42-1.23c0-.35.08-.67.23-.94.16-.27.37-.51.63-.7.26-.2.56-.34.9-.44.34-.1.7-.15 1.08-.15.19 0 .38.01.57.04.19.02.37.06.54.1.17.04.33.09.48.15.15.06.27.12.35.18.12.08.2.16.25.24a.55.55 0 0 1 .07.28v.38c0 .17-.06.26-.18.26a.84.84 0 0 1-.3-.1 3.68 3.68 0 0 0-1.54-.32c-.47 0-.84.08-1.1.24-.26.16-.39.4-.39.73 0 .23.08.43.24.59.16.16.46.32.9.46l1.18.37c.6.19 1.03.46 1.3.81.27.35.4.75.4 1.19 0 .36-.07.69-.22.97a2.2 2.2 0 0 1-.62.73c-.26.2-.58.35-.94.46-.38.1-.78.16-1.22.16Z" />
      <path d="M20.16 16.46c-2.47 1.83-6.06 2.8-9.15 2.8-4.33 0-8.22-1.6-11.17-4.26-.23-.21-.02-.5.25-.33 3.18 1.85 7.11 2.96 11.17 2.96 2.74 0 5.75-.57 8.52-1.74.42-.18.77.27.38.57Z" />
      <path d="M21.17 15.3c-.32-.41-2.1-.19-2.9-.1-.24.03-.28-.18-.06-.34 1.42-1 3.75-.71 4.02-.37.27.34-.07 2.68-1.4 3.8-.21.17-.4.08-.31-.14.3-.74.97-2.43.65-2.85Z" />
    </svg>
  );
}
            ...
            >
              <div className="tool-icon-wrap relative mb-4 grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-[oklch(0.95_0.04_265)] to-[oklch(0.93_0.06_300)] shadow-soft transition-all duration-500 group-hover:scale-110">
                {t.name === "VS Code" ? (
                  ...
                  <OpenAIIcon className="h-8 w-8 text-[oklch(0.2_0_0)]" />
                ) : t.name === "AWS" ? (
                  <AWSIcon className="h-8 w-8 text-[oklch(0.6_0.15_50)]" />
                ) : t.icon ? (
