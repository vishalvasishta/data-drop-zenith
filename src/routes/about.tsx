  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-20 sm:px-8">
      ...
      <p className="mt-6 text-base leading-relaxed text-muted-foreground">
        Welcome to <span className="font-semibold text-foreground">Data Drop Zenith</span>, a learning platform dedicated to helping students and aspiring professionals build practical skills in Artificial Intelligence, Machine Learning, Data Science, and related technologies.
      </p>
