          ...
          <div className="w-full max-w-sm">
            ...
            >
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-br from-[oklch(0.58_0.22_258)] to-[oklch(0.52_0.26_290)] px-6 py-3.5 text-sm font-bold text-white shadow-float transition-all hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading ? (
      ...
      <div className="relative mx-auto max-w-7xl px-5 pt-28 pb-20 sm:px-8 lg:pt-36">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-white/40">
              ...
              {enrollments.length !== 1 ? "s" : ""} · {(leads ?? []).length} lead
              {(leads ?? []).length !== 1 ? "s" : ""}
            </p>
          </div>
        ...
        {activeTab === "enrollments" && (
          <>
            ...
            {pendingCount > 0 && (
              <div className="mb-6 rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 text-amber-300">
                {pendingCount} pending enrollment
                {pendingCount > 1 ? "s" : ""}.
              </div>
            )}
