  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <p className="text-sm font-semibold text-green-300">Got it! A counselor will call you within 2 hours.</p>
      </motion.div>
    );
  }

  return (
    <form onSubmit={handleSubmit} className="mx-4 mb-2 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
      <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-violet-400">Request a Callback</p>
