// ── Objection handling conversation text ───────────────────────────────────────
// Text-only data: keyword triggers paired with their dedicated response. The
// detection algorithm itself lives in engine/objectionHandler.ts.
